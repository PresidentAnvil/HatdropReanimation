...
coroutine.wrap(function() 
    while true do game:GetService("RunService").RenderStepped:Wait()
        ...
        if WDown then  MoveClone(0,0,1e4) if walka.IsPlaying ~= true then  end end
        if ADown then MoveClone(1e4,0,0) if walka.IsPlaying ~= true then  end end
        if SDown then MoveClone(0,0,-1e4) if walka.IsPlaying ~= true then  end end
        if DDown then MoveClone(-1e4,0,0) if walka.IsPlaying ~= true then  end end
