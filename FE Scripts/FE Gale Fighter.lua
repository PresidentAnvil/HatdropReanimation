...
do
	...
	HatdropCallback(RealChar, function(hats, dropped)
        ...
        if RealChar:FindFirstChild(Accessories["FlingPart"][1]) then
            local hat = RealChar:FindFirstChild(Accessories["FlingPart"][1])
			hat.Parent = FakeCharacter
			Align(hat.Handle,flingpart,CFrame.new(0,0,0))
		end
	end)
end
...
plr.CharacterAdded:Connect(function(c)
	...
	HatdropCallback(c, function(hats, dropped)
        ...
        if c:FindFirstChild(Accessories["FlingPart"][1]) then
            local hat = c[Accessories["FlingPart"][1]]
			hat.Parent = FakeCharacter
			Align(hat.Handle,flingpart,CFrame.new(0,0,0))
		end
	end)
